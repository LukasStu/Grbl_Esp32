...
/*
    ...
    Standard eggbot profile with the Robot2Eggbot GPIO remap from
    Robot2Eggbot/plan.md.
*/
...
// Motor GPIO mapping from the conversion plan.
...
// Standard eggbot pen output, remapped to the Robot2Eggbot servo pin.
...
// SPI pin remap for the Micro SD board from the conversion plan.
